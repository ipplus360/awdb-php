...
class Reader
{
    ...
    private static $METADATA_START_MARKER = "\xAB\xCD\xEFipplus360.com";
    private static $METADATA_START_MARKER_LENGTH = 16;
    ...
    /**
     * Constructs a Reader for the aw DB format. The file passed to it must
     * be a valid aw DB file such as a GeoIp2 database file.
     *
     * @param string $database
     *                         the aw DB file to use
     *
     * @throws InvalidArgumentException                    for invalid database path or unknown arguments
     * @throws \aw\Db\Reader\InvalidDatabaseException
    ...
    public function getWithPrefixLen($ipAddress)
    {
        ...
        if (!\is_resource($this->fileHandle)) {
            throw new BadMethodCallException(
                'Attempt to read from a closed aw DB.'
            );
        }
    ...
    /**
     * Closes the aw DB and returns resources to the system.
     *
     * @throws Exception
    ...
    public function close()
    {
        if (!\is_resource($this->fileHandle)) {
            throw new BadMethodCallException(
                'Attempt to close a closed aw DB.'
            );
        }
